...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.BookStore.BankAccounts.BankAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Acme.BookStore.Educamps.Educamp", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.BookStore.Parties.Party", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.BookStore.UserAdressess.UserAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppUserAddressess", (string)null);
                });

            modelBuilder.Entity("Acme.BookStore.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppUsers1", (string)null);
                });
            ...
            modelBuilder.Entity("Acme.BookStore.BankAccounts.BankAccount", b =>
                {
                    b.HasOne("Acme.BookStore.Users.User", "Users")
            ...
            modelBuilder.Entity("Acme.BookStore.UserAdressess.UserAddress", b =>
                {
                    b.HasOne("Acme.BookStore.Users.User", "Users")
                        .WithOne("UserAddressess")
                        .HasForeignKey("Acme.BookStore.UserAdressess.UserAddress", "UserId")
