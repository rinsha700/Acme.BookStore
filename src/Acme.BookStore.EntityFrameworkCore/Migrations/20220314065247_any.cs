    ...
    public partial class any : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUsers1", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppBankAccounts_AppUsers1_UserId",
                        column: x => x.UserId,
                        principalTable: "AppUsers1",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "AppUserAddressess",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserAddressess", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppUserAddressess_AppUsers1_UserId",
                        column: x => x.UserId,
                        principalTable: "AppUsers1",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppBankAccounts_UserId",
                table: "AppBankAccounts",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppUserAddressess_UserId",
                table: "AppUserAddressess",
                column: "UserId",
                unique: true);
        }
